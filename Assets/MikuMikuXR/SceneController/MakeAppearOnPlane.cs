...
public class MakeAppearOnPlane : MonoBehaviour
{
    ...
    bool previousFrameTouched = false;
    ...
    private void Start()
    {
        content = MikuMikuXR.SceneController.MainSceneController.Instance.transform;
    }
    ...
    void Update()
    {
        ...
        {
            previousFrameTouched = true;
            return;
        }
        if (previousFrameTouched == true)
        {
            previousFrameTouched = false;
            return;
        }
